...
const ContactNew = ({ formData }) => {
  ...
  // Validate title
  const formTitle = validateString(formData.form_title.text)
  // Validate description
  const formDecription = validateString(formData.from_content.raw)
  // Form data
  const formDataFields = formData.body
  // Get colour
